...
*  An outer JSON object that acts as the SET "envelope".  The
...
*  Envelope claims that are profiled and defined in this
...
*  Each JSON member of the "events" object is a name and value pair.
...
*  An "iss" claim, denoting the Event Transmitter.

*  The "sub" claim specifies the SCIM resource URI that was affected.

*  The "aud" claim specifies the intended audiences for the event.
...
~~~
{: #figlogoutevent title="Example OpenID Back-Channel Logout Event"}
...
~~~
{: #figconsentevent title="Example Consent Event"}
...
toe
: A number whose value is a Numeric Data ( see Section 2 [RFC7519]).
...
sub
: As defined by Section 4.1.2 [RFC7519], a String or URI value
...
exp
: As defined by [RFC7519], this claim is time on which the JWT
...
~~~
{: #figclaims title="Example Event Claims"}
